...
[My new blog!](https://blog.alec.casa)

[See what I'm reading online.](https://read.alec.casa)
...
* [What I'm reading online](reading) — I wanted to keep better track of what I'm reading online and share it, so I made some little bookmarklets that ping [a wee Glitch server](https://glitch.com/#!/project/alec-reads), which saves my reading into a Firebase database, which is then presented by a [totally static page](https://read.alec.casa) that formats the data with [Mustache templates](https://mustache.github.io/). Playing with lots of different little technologies! I hope to make this prettier soon.
